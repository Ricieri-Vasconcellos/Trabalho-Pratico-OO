...
public class ClienteVIP extends Cliente {
    ...
    public static final int TAXA_CONVERSAO = 10; // 10 XP = R$ 1;
    ...
    public void pagarComXP(double valorTotal) throws PontosInsuficientesException
    {
        ...
        {
            throw new PontosInsuficientesException("Saldo de XP insuficiente. Necessário: " + xpNecessario + ", atual: " + getSaldoXP());
        } else {
            setSaldoXP(getSaldoXP() - xpNecessario);
        }
    }
